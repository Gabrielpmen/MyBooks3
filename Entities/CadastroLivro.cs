...
namespace RepositorioLivros.Entities
{
    public class CadastroLivro
    {
        ...
        public CadastroLivro(string titulo, string genero, string midia, DateTime anoLancamento, string statusLeitura, DateTime anoCompra, double valorPago, string autor, bool esaga)
        {
            Titulo = titulo;
            Genero = genero;
            Midia = midia;
